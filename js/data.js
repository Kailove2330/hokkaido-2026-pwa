...
const DAYS = [
  {
    ...
    items: [
      ...
      { time: '13:35', place: { zh: '新千歲機場 第 I 航廈', en: 'New Chitose Airport T-I' }, duration: '60min', note: { zh: '⚡ 出關後立刻 JR 窗口劃位：5/18 北斗號 D 席（右側海景）', en: '⚡ Right after customs: reserve Hokuto D-seat for 5/18 (sea view)' }, maps: 'https://maps.google.com/?q=New+Chitose+Airport', coord: [42.7751, 141.6924], warn: true },
      ...
      { time: '15:30', place: { zh: '索拉瑞亞西鐵酒店 Check-in', en: 'Solaria Nishitetsu Check-in' }, duration: '30min', note: { zh: '行李寄放換輕裝', en: 'Drop luggage, change to light wear' }, maps: 'https://maps.google.com/?q=Solaria+Nishitetsu+Hotel+Sapporo', coord: [43.0606, 141.3565], warn: false },
      { time: '17:00', place: { zh: '🍖【晚餐】成吉思汗達摩 5.5 店', en: '🍖 Dinner: Daruma 5.5 (Genghis Khan BBQ)' }, duration: '90min', note: { zh: '避開首波人潮；烤羊 2,500–3,500円/人', en: 'Avoid first rush; lamb ¥2,500–3,500/person' }, maps: 'https://maps.google.com/?q=Daruma+Sapporo+Genghis+Khan', coord: [43.0524, 141.3545], warn: false },
      { time: '19:00', place: { zh: '狸小路 + 薄野散步（NIKKA 看板地標）', en: 'Tanukikoji & Susukino Walk (NIKKA Sign Landmark)' }, duration: '60min', note: { zh: '藥妝比價（松本清、SUNDRUG、Welcia）', en: 'Drugstore compare: Matsumoto Kiyoshi, SUNDRUG, Welcia' }, maps: 'https://maps.google.com/?q=Tanukikoji+Shopping+Street+Sapporo', coord: [43.0559, 141.3508], warn: false },
      { time: '20:30', place: { zh: '🍨 Parfaiteria PaL（夜聖代）', en: '🍨 Parfaiteria PaL (Night Parfait)' }, duration: '60min', note: { zh: '北海道牛奶夜聖代；夜間限定；建議 20:30 前入店', en: 'Hokkaido milk night parfait; nighttime exclusive; arrive by 20:30' }, maps: 'https://maps.google.com/?q=Parfaiteria+PaL+Sapporo', coord: [43.0503, 141.3545], warn: false },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { time: '10:30', place: { zh: '⭐ 北一硝子 三號館（煤油燈咖啡廳）', en: '⭐ Kitaichi Glass No.3 (Kerosene Lamp Café)' }, duration: '90min', note: { zh: '禁閃光燈/腳架；手作玻璃杯 3,000–8,000円', en: 'No flash/tripod; handmade glass ¥3,000–8,000' }, maps: 'https://maps.google.com/?q=Kitaichi+Glass+No3+Otaru', coord: [43.1844, 140.9939], warn: false },
      ...
      { time: '14:30', place: { zh: '堺町通 + 小樽音樂盒堂 本館', en: 'Sakaimachi Street + Otaru Music Box Museum' }, duration: '60min', note: { zh: '音樂盒堂本館免費參觀；限定款 3,000円起', en: 'Music Box Museum free entry; limited editions from ¥3,000' }, maps: 'https://maps.google.com/?q=小樽オルゴール堂本館', coord: [43.1909, 140.9953], warn: false },
      { time: '15:30', place: { zh: '⭐ LeTAO 小樽總店（二樓內用現做雙層乳酪蛋糕）', en: '⭐ LeTAO Main Store (2F Fresh Double Fromage)' }, duration: '90min', note: { zh: '⚡ 停留 90 分；二樓現做雙層乳酪蛋糕 900円；附飲料套餐 1,400円', en: '⚡ Allow 90 min; 2F fresh Double Fromage ¥900; drink set ¥1,400' }, maps: 'https://maps.google.com/?q=LeTAO+Otaru', coord: [43.1866, 140.9932], warn: true },
      { time: '17:30', place: { zh: '⭐ 小樽運河夜景散步 → JR 返回札幌', en: '⭐ Otaru Canal Night Walk → JR Back to Sapporo' }, duration: '60min', note: { zh: '⚡ 黃金窗口 17:30–18:30（點燈最美）；JR 約 50 分返回', en: '⚡ Golden window 17:30–18:30 (lanterns lit); JR ~50 min back' }, maps: 'https://maps.google.com/?q=Otaru+Canal', coord: [43.1922, 140.9956], warn: true },
      ...
      { time: '20:00', place: { zh: '🍨 Sato（夜聖代）', en: '🍨 Sato Night Parfait' }, duration: '60min', note: { zh: '達成「拉麵接聖代」成就！夜間限定聖代', en: '"Ramen → Parfait" achievement unlocked! Night-only dessert' }, maps: 'https://maps.google.com/?q=パフェ+さとう+札幌', coord: [43.0548, 141.3546], warn: false },
    ],
  ...
  },
  {
    ...
    weatherCity: 'Sapporo',
    items: [
      { time: '08:30', place: { zh: '🍞【早餐】Espresso D Works（100% 水份吐司）', en: '🍞 Breakfast: Espresso D Works (100% Moisture Toast)' }, duration: '45min', note: { zh: '札幌名店；水分吐司現烤；建議 08:30 前入座', en: 'Sapporo icon; steam-hydrated toast; arrive by 08:30' }, maps: 'https://maps.google.com/?q=Espresso+D+Works+Sapporo', coord: [43.0601, 141.3504], warn: false },
      { time: '10:00', place: { zh: '飯店轉移：行李移至京王 Prelia', en: 'Hotel Transfer: Luggage to Keio Prelia' }, duration: '30min', note: { zh: '請飯店代管至 check-in 時間', en: 'Ask hotel to hold until check-in' }, maps: 'https://maps.google.com/?q=Keio+Prelia+Hotel+Sapporo', coord: [43.0609, 141.3563], warn: false },
      { time: '11:00', place: { zh: '⭐ 白色戀人公園（工廠參觀 + 舒芙蕾鬆餅 + 訂製磁鐵）', en: '⭐ Shiroi Koibito Park (Factory Tour + Soufflé Pancake + Custom Magnet)' }, duration: '90min', note: { zh: '⚡ 線上預購工廠參觀電子票（1,000円）；訂製磁鐵 1,500円起', en: '⚡ Pre-buy factory tour e-ticket online (¥1,000); custom magnet from ¥1,500' }, maps: 'https://maps.google.com/?q=Shiroi+Koibito+Park+Sapporo', coord: [43.0882, 141.2983], warn: true },
      { time: '13:00', place: { zh: '🍱【午餐】とんかつ 檍（頂級炸豬排）', en: '🍱 Lunch: Tonkatsu Aoki (Premium Pork Cutlet)' }, duration: '60min', note: { zh: '特上ロースかつ 2,500–4,000円；麥飯 + 高麗菜無限續', en: 'Premium loin cutlet ¥2,500–4,000; rice + cabbage refill unlimited' }, maps: 'https://maps.google.com/?q=とんかつ+檍+札幌', coord: [43.0612, 141.3520], warn: false },
      { time: '15:30', place: { zh: '北海道神宮 / 圓山公園（判官燒 + 福餅）', en: 'Hokkaido Jingu / Maruyama Park (Hangan-yaki + Fuku-mochi)' }, duration: '75min', note: { zh: '⚡ 抵達後優先買「判官さま」現烤麻糬（限量）300円；圓山公園湖畔散步', en: '⚡ Buy "Hangan-sama" grilled mochi first — sells out; ¥300; Maruyama lakeside stroll' }, maps: 'https://maps.google.com/?q=Hokkaido+Jingu+Shrine', coord: [43.0534, 141.3211], warn: true },
      { time: '16:45', place: { zh: '京王 Prelia 辦入住', en: 'Keio Prelia Check-in' }, duration: '30min', note: { zh: '換保暖防風外套準備上山', en: 'Change to warm windproof layers for mountain' }, maps: 'https://maps.google.com/?q=Keio+Prelia+Hotel+Sapporo', coord: [43.0609, 141.3563], warn: false },
      { time: '17:30', place: { zh: '⭐ 藻岩山展望台（觀賞日落至夜景）', en: '⭐ Mt. Moiwa Observatory (Sunset to Night View)' }, duration: '120min', note: { zh: '⚡ 山頂風強溫差大，帶防風外套；纜車來回 2,100円；5 月日落約 18:30', en: '⚡ Strong wind at top — windproof jacket essential; ¥2,100 RT; sunset ~18:30 in May' }, maps: 'https://maps.google.com/?q=Mt+Moiwa+Ropeway+Sapporo', coord: [43.0291, 141.3240], warn: true },
      { time: '20:00', place: { zh: '🥩【慶祝晚餐】牛しゃぶ 牛すき 禪（黑毛和牛壽喜燒）', en: '🥩 Celebration Dinner: Zen Wagyu Shabu & Sukiyaki' }, duration: '120min', note: { zh: '⭐️ 黑毛和牛；⚡ 備注：不吃生食（請全熟處理）；需提前預約', en: '⭐️ Kuroge wagyu; ⚡ Note: fully cooked only (no raw); advance reservation required' }, maps: 'https://maps.google.com/?q=牛しゃぶ+牛すき+禪+札幌', coord: [43.0559, 141.3543], warn: true },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { time: '09:00', place: { zh: '歷史地標打卡（紅磚廳舍 → 時計台 → 電視塔）', en: 'Historic Landmarks (Red Brick Hall → Clock Tower → TV Tower)' }, duration: '75min', note: { zh: '時計台內部 200円；電視塔展望台 700円（選做）', en: 'Clock Tower interior ¥200; TV Tower observatory ¥700 (optional)' }, maps: 'https://maps.google.com/?q=Sapporo+Clock+Tower', coord: [43.0638, 141.3538], warn: false },
      { time: '10:30', place: { zh: '中島公園 / 豐平館（晨間湖畔 + 明治洋樓）', en: 'Nakajima Park / Hoheikan (Morning Lakeside + Meiji Hall)' }, duration: '60min', note: { zh: '豐平館參觀 300円；中島公園免費；湖畔空氣最佳', en: 'Hoheikan ¥300; Nakajima Park free; best morning air by the lake' }, maps: 'https://maps.google.com/?q=Nakajima+Park+Sapporo', coord: [43.0442, 141.3539], warn: false },
      { time: '11:45', place: { zh: '🛍️【核心採購啟動】大丸 → Stellar Place → APIA → PARCO', en: '🛍️ Core Shopping: Daimaru → Stellar Place → APIA → PARCO' }, duration: '90min', note: { zh: '⚡ 先至 GARAKU 抽整理券再逛街；UNIQLO、大國藥妝、3COINS、SERIA、大創', en: '⚡ Grab GARAKU ticket first, then shop: UNIQLO, Daikoku, 3COINS, SERIA, Daiso' }, maps: 'https://maps.google.com/?q=Daimaru+Sapporo', coord: [43.0681, 141.3505], warn: true },
      { time: '13:30', place: { zh: '🍛【午餐】GARAKU 湯咖哩', en: '🍛 Lunch: GARAKU Soup Curry' }, duration: '60min', note: { zh: '札幌神級名店；海老ベース湯咖哩 1,500–2,200円；辣度 0–40 可選', en: 'Sapporo legend; shrimp broth soup curry ¥1,500–2,200; spice level 0–40' }, maps: 'https://maps.google.com/?q=GARAKU+札幌', coord: [43.0604, 141.3555], warn: false },
      { time: '15:30', place: { zh: '☕ 千秋庵本店（巴里銅鑼）', en: '☕ Senshuya Main Store (Bali Dorayaki)' }, duration: '30min', note: { zh: '中繼體力補給；現烤バリ銅鑼（僅限本店）', en: 'Mid-afternoon fuel; freshly baked Bali Dorayaki (in-store only)' }, maps: 'https://maps.google.com/?q=千秋庵本店+札幌', coord: [43.0603, 141.3540], warn: false },
      ...
      { time: '20:00', place: { zh: '🦀【晚餐】札幌かに本家 站前總店（全熟螃蟹火鍋）', en: '🦀 Dinner: Sapporo Kani Honke (Fully Cooked Crab Hot Pot)' }, duration: '120min', note: { zh: '⭐️ 建議選擇包廂；全熟螃蟹套餐 8,000–15,000円；需提前預約', en: '⭐️ Request private room; fully cooked crab course ¥8,000–15,000; reserve ahead' }, maps: 'https://maps.google.com/?q=札幌かに本家+站前総店', coord: [43.0576, 141.3556], warn: true },
    ],
  ...
  },
  {
    ...
    items: [
      { time: '08:00', place: { zh: '🍞【早餐】DONGURI（靈魂麵包）', en: '🍞 Breakfast: DONGURI (Soul Bread)' }, duration: '30min', note: { zh: '札幌人氣麵包店；每日現烤', en: 'Sapporo beloved bakery; baked fresh daily' }, maps: 'https://maps.google.com/?q=DONGURI+Sapporo', coord: [43.0596, 141.3505], warn: false },
      ...
      { time: '14:30', place: { zh: 'Century Marina Hakodate Check-in（此後五天輕裝移動）', en: 'Century Marina Hakodate Check-in (light pack for next 5 days)' }, duration: '30min', note: { zh: '指定高層靠海側；此後進入全面輕裝狀態', en: 'Request high floor sea-facing room; travel light from here on' }, maps: 'https://maps.google.com/?q=Century+Marina+Hakodate', coord: [41.7739, 140.7264], warn: false },
      { time: '15:30', place: { zh: '☕ 幸運小丑漢堡 碼頭末廣店（下午茶）', en: '☕ Lucky Pierrot Suehiro Branch (Afternoon Snack)' }, duration: '30min', note: { zh: '分食一份炸雞漢堡；函館限定品牌；中華雞腿堡 580円', en: 'Share one Chinese Chicken Burger; Hakodate-only chain; ¥580' }, maps: 'https://maps.google.com/?q=Lucky+Pierrot+Hakodate+Suehiro', coord: [41.7758, 140.7218], warn: false },
      { time: '17:30', place: { zh: '⭐ 函館山觀景台（百萬夜景）', en: '⭐ Mt. Hakodate Observatory (Million Dollar Night View)' }, duration: '90min', note: { zh: '⚡ 出發前查官網風力（15m/s 停駛）；纜車來回 1,500円；山頂比市區冷 5–8°C', en: '⚡ Check wind speed before going (stops at 15m/s); ¥1,500 RT; top is 5–8°C colder' }, maps: 'https://maps.google.com/?q=函館山ロープウェイ', coord: [41.7611, 140.7028], warn: true },
      { time: '20:00', place: { zh: '🍜【晚餐】味彩（鹽拉麵）', en: '🍜 Dinner: Ajisai (Salt Ramen)' }, duration: '60min', note: { zh: '函館鹽拉麵老舖；透明清湯；800–1,200円', en: 'Hakodate salt ramen institution; clear broth; ¥800–1,200' }, maps: 'https://maps.google.com/?q=味彩+函館', coord: [41.7698, 140.7180], warn: false },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { time: '11:30', place: { zh: '函館朝市 + 金森紅磚倉庫散步', en: 'Hakodate Morning Market + Kanemori Warehouse Stroll' }, duration: '90min', note: { zh: '朝市自由逛（海鮮、干貝、熟食）；金森倉庫明治大正紅磚群，免費', en: 'Morning market browse (seafood, scallops, cooked goods); Kanemori free entry' }, maps: 'https://maps.google.com/?q=Hakodate+Morning+Market', coord: [41.7755, 140.7274], warn: false },
      { time: '13:00', place: { zh: '🦔【午餐】村上海膽（全熟解鎖：焗烤海膽 / 烤海膽）', en: '🦔 Lunch: Murakami Uni (Fully Cooked: Gratin / Grilled Uni)' }, duration: '60min', note: { zh: '⚡ 全熟點法：焗烤ウニ、炙り烤ウニ（避開生ウニ）；當季套餐 3,000–6,000円', en: '⚡ Fully cooked options: uni gratin, grilled uni (skip raw); seasonal set ¥3,000–6,000' }, maps: 'https://maps.google.com/?q=村上海膽+函館', coord: [41.7730, 140.7260], warn: true },
      { time: '14:30', place: { zh: '⭐ 五稜郭展望塔 / 公園', en: '⭐ Goryokaku Tower / Park' }, duration: '90min', note: { zh: '⚡ 塔頂展望台 900円（★必上）；公園內自由散步', en: '⚡ Tower observation ¥900 (★must do); free stroll in park' }, maps: 'https://maps.google.com/?q=Goryokaku+Tower+Hakodate', coord: [41.7961, 140.7578], warn: true },
      { time: '16:30', place: { zh: '⭐ 八幡坂 / 元町建築群（大正風情漫步）', en: '⭐ Hachiman-zaka / Motomachi (Taisho-era Stroll)' }, duration: '60min', note: { zh: '⚡ 注意車流；八幡坂海港透視日落最美；舊區公會堂 300円', en: '⚡ Watch traffic; Hachiman-zaka sea view best at sunset; Old Public Hall ¥300' }, maps: 'https://maps.google.com/?q=Hachiman-zaka+Hakodate', coord: [41.7672, 140.7144], warn: true },
      { time: '18:00', place: { zh: '🍛【晚餐】奧芝商店 函館本店（蝦味湯咖哩）', en: '🍛 Dinner: Okushiba Hakodate (Shrimp Soup Curry)' }, duration: '90min', note: { zh: '⚡ 已避開週一・週二公休；海老スープカレー 1,500–2,500円；辣度 1–30', en: '⚡ Avoids Mon/Tue closures; shrimp soup curry ¥1,500–2,500; spice level 1–30' }, maps: 'https://maps.google.com/?q=奥芝商店+函館本店', coord: [41.7686, 140.7158], warn: true },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { time: '09:30', place: { zh: 'JR 前往登別 → 轉乘巴士至溫泉街', en: 'JR to Noboribetsu → Bus to Onsen Town' }, duration: '30min', note: { zh: '⚡ 確認班次；洞爺→登別約 20 分（JR）；登別站→溫泉街巴士約 10 分', en: '⚡ Check schedule; Toya→Noboribetsu ~20 min (JR); station→onsen street bus ~10 min' }, maps: 'https://maps.google.com/?q=Noboribetsu+Station', coord: [42.4027, 141.1004], warn: true },
      { time: '10:30', place: { zh: '⭐ 登別地獄谷 / 大湯沼川天然足湯', en: '⭐ Noboribetsu Jigokudani / Oyunuma Natural Footbath' }, duration: '150min', note: { zh: '⚡ 地獄谷免費；大湯沼展望台免費；足湯免費（帶毛巾）；鬼石棒之湯選做 1,500円', en: '⚡ Hell Valley free; Oyunuma lookout free; footbath free (bring towel); optional onsen ¥1,500' }, maps: 'https://maps.google.com/?q=Noboribetsu+Jigokudani', coord: [42.4519, 141.1093], warn: true },
  ...
  },
  {
    ...
    items: [
      ...
      { time: '09:30', place: { zh: '退房 → JR 洞爺站', en: 'Check-out → JR Toya Station' }, duration: '30min', note: { zh: '計程車至洞爺站 ~1,500円', en: 'Taxi to Toya Station ~¥1,500' }, maps: 'https://maps.google.com/?q=Toya+Station', coord: [42.6278, 140.8437], warn: false },
      ...
      { time: '11:45', place: { zh: '⚡【物流回收】黑貓 Yamato 領回大件行李', en: '⚡ Luggage Pickup: Yamato Counter (Large Bags)' }, duration: '30min', note: { zh: '憑 5/18 宅急便單據，於國內線/國際線黑貓櫃檯領取', en: 'Use 5/18 Yamato receipt; collect at domestic/intl Yamato counter' }, maps: 'https://maps.google.com/?q=New+Chitose+Airport', coord: [42.7751, 141.6924], warn: true },
      ...
      { time: '13:00', place: { zh: '🍜【午餐】一幻拉麵（國內線 3F）→ 2F 最終名產採買', en: '🍜 Lunch: Ichigen Ramen (Domestic 3F) → 2F Final Souvenir Shopping' }, duration: '90min', note: { zh: '蝦味噌拉麵 1,200円；2F：KINOTOYA 起司塔、薯條三兄弟等', en: 'Shrimp miso ramen ¥1,200; 2F: KINOTOYA cheese tart, Jaga Pokkuru, etc.' }, maps: 'https://maps.google.com/?q=一幻+新千歲空港', coord: [42.7751, 141.6924], warn: false },
