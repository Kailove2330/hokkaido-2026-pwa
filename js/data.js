...
const T = {
  ...
  en: {
    ...
    tabs: ['Itinerary', 'Souvenirs', 'Transport', 'Checklist', 'SOS', 'Overview'],
    day: 'Day', dayUnit: '',
    steps: 'Est. steps',
    stepsUnit: 'steps',
    mapBtn: 'Map',
...
const DAYS = [
  ...
  },
  {
    ...
    items: [
      ...
      { time: '17:30', place: { zh: '⭐ 藻岩山展望台（觀賞日落至夜景）', en: '⭐ Mt. Moiwa Observatory (Sunset to Night View)' }, duration: '120min', note: { zh: '⚡ 山頂風強溫差大，帶防風外套；纜車來回 2,100円；5 月日落約 18:30', en: '⚡ Strong wind at top — windproof jacket essential; ¥2,100 RT; sunset ~18:30 in May' }, maps: 'https://maps.google.com/?q=Mt+Moiwa+Ropeway+Sapporo', coord: [43.0291, 141.3240], img: 'images/itinerary/moiwa.jpg', warn: true },
  ...
  },
  {
    ...
    items: [
      ...
      { time: '14:30', place: { zh: '⭐ 五稜郭展望塔 / 公園', en: '⭐ Goryokaku Tower / Park' }, duration: '90min', note: { zh: '⚡ 塔頂展望台 900円（★必上）；公園內自由散步', en: '⚡ Tower observation ¥900 (★must do); free stroll in park' }, maps: 'https://maps.google.com/?q=Goryokaku+Tower+Hakodate', coord: [41.7961, 140.7578], img: 'images/itinerary/goryokaku.jpg', warn: true },
      { time: '16:30', place: { zh: '⭐ 八幡坂 / 元町建築群（大正風情漫步）', en: '⭐ Hachiman-zaka / Motomachi (Taisho-era Stroll)' }, duration: '60min', note: { zh: '⚡ 注意車流；八幡坂海港透視日落最美；舊區公會堂 300円', en: '⚡ Watch traffic; Hachiman-zaka sea view best at sunset; Old Public Hall ¥300' }, maps: 'https://maps.google.com/?q=Hachiman-zaka+Hakodate', coord: [41.7672, 140.7144], img: 'images/itinerary/hachimanzaka.jpg', warn: true },
