...
const DAYS = [
  // Day 1
  {
    ...
    items: [
      ...
      { time: '16:04', place: { zh: '甜點老店 千秋庵 本店', en: 'Senshuya Confectionery Main Store' }, duration: '15min', note: { zh: '明治 41 年創業；バリ銅鑼（現烤銅鑼燒）300円，僅本店', en: 'Est. 1908; Bali Dorayaki 300 yen - main store only' }, maps: 'https://maps.google.com/?q=千秋庵本店+札幌', coord: [43.0602, 141.3544], warn: false },
  ...
  // Day 4
  {
    ...
    items: [
      ...
      { time: '12:53', place: { zh: '北海道廳紅磚廳舍（舊本廳舍）', en: 'Former Hokkaido Gov. Office (Red Brick Hall)' }, duration: '15min', note: { zh: '免費；庭園散步；仿美國麻薩諸塞州廳舍', en: 'Free; garden stroll; modeled after Massachusetts State House' }, maps: 'https://maps.google.com/?q=北海道庁赤れんが庁舎', coord: [43.0626, 141.3470], warn: false },
      { time: '13:17', place: { zh: '札幌市鐘樓（時計台）', en: 'Sapporo Clock Tower (Tokeidai)' }, duration: '15min', note: { zh: '外觀拍照免費；內部 200円', en: 'Free to photograph; 200 yen inside' }, maps: 'https://maps.google.com/?q=Sapporo+Clock+Tower', coord: [43.0638, 141.3538], warn: false },
      { time: '13:38', place: { zh: '大通公園', en: 'Odori Park' }, duration: '15min', note: { zh: '中央草地景觀；電視塔展望台 700円（選做）', en: 'Central park greenery; TV Tower observatory 700 yen (optional)' }, maps: 'https://maps.google.com/?q=Odori+Park+Sapporo', coord: [43.0613, 141.3538], warn: false },
      { time: '13:56', place: { zh: '札幌電視塔', en: 'Sapporo TV Tower' }, duration: '15min', note: { zh: '展望台 700円；視天氣決定是否上頂', en: 'Observatory 700 yen; decide based on weather' }, maps: 'https://maps.google.com/?q=Sapporo+TV+Tower', coord: [43.0613, 141.3576], warn: false },
  ...
  // Day 5
  {
    ...
    items: [
      { time: '07:00', place: { zh: '🍳 京王 Prelia 早餐 + 退房', en: '🍳 Keio Prelia Breakfast + Check-out' }, duration: '150min', note: { zh: '⚡ 宅急便大件行李寄至新千歲（5/22 取）；費用 1,500–2,500円/件', en: '⚡ Yamato forward large bags to New Chitose (pick up 5/22); 1,500-2,500 yen/bag' }, maps: null, warn: true },
      { time: '10:00', place: { zh: 'shiro（北海道發祥天然美妝）', en: 'shiro (Hokkaido-born Natural Cosmetics)' }, duration: '60min', note: { zh: '清酒 / 米糠 / 北海道素材；不含合成香料', en: 'Sake / rice bran / Hokkaido ingredients; no synthetic fragrance' }, maps: 'https://maps.google.com/?q=shiro+Sapporo', coord: [43.0680, 141.3502], warn: false },
      { time: '11:01', place: { zh: '3COINS SAPPORO APIA', en: '3COINS Sapporo Apia' }, duration: '60min', note: { zh: '300円均一雜貨；旅途小物', en: '300 yen variety goods; travel accessories' }, maps: 'https://maps.google.com/?q=3COINS+APIA+札幌', coord: [43.0687, 141.3506], warn: false },
      { time: '12:03', place: { zh: '🐷【午餐】十勝豚丼 いっぴん 札幌車站店', en: '🐷 Lunch: Tokachi Butadon Ippin (Sapporo Station)' }, duration: '15min', note: { zh: '帶廣名物豚丼；甜醬汁燒豚肉', en: 'Obihiro specialty pork rice bowl; sweet tare glaze' }, maps: 'https://maps.google.com/?q=十勝豚丼いっぴん+札幌', coord: [43.0682, 141.3503], warn: false },
      { time: '12:30', place: { zh: '⚡ JR 特急北斗號 出發（D 席右側海景）', en: '⚡ JR Hokuto Limited Express (D-seat sea view)' }, duration: '219min', note: { zh: '⚡ D 席右側內浦灣全景；全車指定席；車資 ~9,000円', en: '⚡ D-seat right = Uchiura Bay view; all reserved; approx 9,000 yen' }, maps: null, warn: true },
      { time: '16:09', place: { zh: '🍔 幸運小丑漢堡 函館站前店', en: '🍔 Lucky Pierrot Hakodate Station Branch' }, duration: '15min', note: { zh: '函館限定；中華雞腿堡 580円；分食嚐鮮', en: 'Hakodate-only chain; Chinese chicken burger 580 yen; share one' }, maps: 'https://maps.google.com/?q=Lucky+Pierrot+函館駅前', coord: [41.7741, 140.7275], img: 'images/itinerary/lucky-pierrot.jpg', warn: false },
      { time: '16:29', place: { zh: '函館世紀濱海酒店 Check-in', en: 'Century Marina Hakodate Check-in' }, duration: '30min', note: { zh: '指定高層靠海側；換保暖外套準備上山', en: 'Request high floor sea-facing room; change to warm layers for mountain' }, maps: 'https://maps.google.com/?q=Century+Marina+Hakodate', coord: [41.7739, 140.7264], warn: false },
      { time: '17:45', place: { zh: '⭐ 函館山觀景台（百萬夜景）', en: '⭐ Mt. Hakodate Observatory (Million Dollar Night View)' }, duration: '105min', note: { zh: '⚡ 出發前查官網風力（15m/s 停駛）；纜車來回 1,500円；山頂比市區冷 5–8°C', en: '⚡ Check wind speed first (stops at 15m/s); 1,500 yen RT; top is 5-8°C colder' }, maps: 'https://maps.google.com/?q=函館山ロープウェイ', coord: [41.7611, 140.7028], img: 'images/itinerary/hakodate-mt.jpg', warn: true },
      { time: '20:01', place: { zh: '🍜【晚餐】鹽拉麵 あじさい 紅店', en: '🍜 Dinner: Ajisai Salt Ramen (Beni-ten)' }, duration: '60min', note: { zh: '函館鹽拉麵名店；清透金色湯頭；800–1,200円', en: "Hakodate's famous salt ramen; crystal clear golden broth; 800-1,200 yen" }, maps: 'https://maps.google.com/?q=あじさい+函館+塩ラーメン', coord: [41.7752, 140.7269], warn: false },
      { time: '21:11', place: { zh: '函館世紀濱海酒店', en: 'Century Marina Hakodate' }, duration: '60min', note: null, maps: null, warn: false },
    ],
    mealBudget: { zh: '午餐 900円 + 晚餐 1,000円／人', en: 'Lunch 900 + dinner 1,000 yen/person' },
    shopping: { zh: 'shiro 美妝；3COINS 旅途小物', en: 'shiro cosmetics; 3COINS travel accessories' },
  },
  // Day 6
  {
    ...
    items: [
      ...
      { time: '10:05', place: { zh: '函館朝市（現烤扇貝 + 毛蟹腳）', en: 'Hakodate Morning Market (Grilled Scallops + Crab Legs)' }, duration: '60min', note: { zh: '⚡ 奶油烤扇貝 + 毛蟹腳各 300–500円；避開生食區', en: '⚡ Butter scallops + hairy crab legs 300-500 yen each; skip raw seafood' }, maps: 'https://maps.google.com/?q=Hakodate+Morning+Market', coord: [41.7755, 140.7274], warn: true },
      { time: '11:24', place: { zh: '⭐ 八幡坂（函館港透視景）', en: '⭐ Hachiman-zaka (Hakodate Port Vista)' }, duration: '15min', note: { zh: '⚡ 注意車流；坡頂港口透視最美；元町洋館群起點', en: '⚡ Watch traffic; best port perspective from top; start of Motomachi stroll' }, maps: 'https://maps.google.com/?q=Hachiman-zaka+Hakodate', coord: [41.7672, 140.7144], img: 'images/itinerary/hachimanzaka.jpg', warn: true },
      { time: '11:47', place: { zh: '金森紅磚倉庫（明治大正建築群）', en: 'Kanemori Red Brick Warehouse (Meiji-Taisho Architecture)' }, duration: '90min', note: { zh: '免費；內有特色小店 + 咖啡；沿港岸步行', en: 'Free entry; unique shops + cafes inside; scenic harbour walk' }, maps: 'https://maps.google.com/?q=金森赤レンガ倉庫+函館', coord: [41.7682, 140.7183], warn: false },
      { time: '13:36', place: { zh: '🦔【午餐】Uni Murakami 函館本店（全熟海膽）', en: '🦔 Lunch: Uni Murakami Hakodate (Cooked Uni)' }, duration: '90min', note: { zh: '⚡ 全熟：焗烤ウニ / 炙り烤ウニ（避開生ウニ）；套餐 3,000–6,000円', en: '⚡ Fully cooked: uni gratin / grilled uni (skip raw); set 3,000-6,000 yen' }, maps: 'https://maps.google.com/?q=村上海膽+函館本店', coord: [41.7730, 140.7260], warn: true },
      { time: '15:41', place: { zh: '⭐ 五稜郭展望塔 / 公園', en: '⭐ Goryokaku Tower & Park' }, duration: '90min', note: { zh: '⚡ 塔頂展望台 900円（★必上）；五芒星要塞俯瞰', en: '⚡ Tower observatory 900 yen (must do); star fort aerial view' }, maps: 'https://maps.google.com/?q=Goryokaku+Tower+Hakodate', coord: [41.7961, 140.7578], img: 'images/itinerary/goryokaku.jpg', warn: true },
      { time: '17:31', place: { zh: 'Seria（百円雜貨）', en: 'Seria (100-yen Variety Store)' }, duration: '60min', note: { zh: '日本百元店品質最高；生活雜貨、旅遊文具', en: "Japan's highest-quality 100-yen store; lifestyle goods & stationery" }, maps: 'https://maps.google.com/?q=Seria+函館', coord: [41.7739, 140.7600], warn: false },
      { time: '18:55', place: { zh: '🍛【晚餐】奧芝商店 函館本店（蝦味湯咖哩）', en: '🍛 Dinner: Okushiba Hakodate (Shrimp Soup Curry)' }, duration: '90min', note: { zh: '海老スープカレー 1,500–2,500円；辣度 1–30', en: 'Shrimp soup curry 1,500-2,500 yen; spice level 1-30' }, maps: 'https://maps.google.com/?q=奥芝商店+函館本店', coord: [41.7686, 140.7158], warn: false },
      { time: '21:00', place: { zh: '函館世紀濱海酒店', en: 'Century Marina Hakodate' }, duration: '60min', note: null, maps: null, warn: false },
    ],
    mealBudget: { zh: '朝市 500–800円 + 午餐 4,000–6,000円 + 晚餐 2,000円／人', en: 'Market 500-800 + lunch 4,000-6,000 + dinner 2,000 yen/person' },
    shopping: { zh: "SNAFFLE'S 起司歐姆蕾蛋糕（需冷藏）；Seria 百元雜貨", en: "SNAFFLE'S Cheese Omelette Catchcakes (refrigerate); Seria 100-yen goods" },
  },
  // Day 7
  {
    ...
    items: [
      ...
      { time: '10:40', place: { zh: 'JR 特急北斗號 函館 → 洞爺（約 1.5 時間）', en: 'JR Hokuto Express: Hakodate to Toya (about 1.5 hr)' }, duration: '90min', note: { zh: '車資 ~4,000–5,000円；洞爺站下車', en: 'Approx 4,000-5,000 yen; exit at Toya Station' }, maps: null, warn: false },
      { time: '12:44', place: { zh: 'JR 洞爺站 抵達', en: 'Arrive JR Toya Station' }, duration: '15min', note: { zh: '計程車至乃之風 ~5 分 / 1,000円', en: 'Taxi to Nonokaze ~5 min / 1,000 yen' }, maps: 'https://maps.google.com/?q=Toya+Station', coord: [42.6278, 140.8437], warn: false },
      ...
      { time: '13:46', place: { zh: '🍵【午餐】岡田屋（白汁粉）', en: '🍵 Lunch: Okadaya (White Sweet Soup)' }, duration: '30min', note: { zh: '白玉白汁粉 600–900円；溫泉街名物', en: 'White mochi sweet soup 600-900 yen; onsen street specialty' }, maps: 'https://maps.google.com/?q=岡田屋+洞爺湖', coord: [42.6022, 140.7897], warn: false },
      { time: '14:29', place: { zh: '筒倉展望台 Silo（洞爺湖全景 + 布丁）', en: 'Toya Silo Observatory (Lake Panorama + Pudding)' }, duration: '30min', note: { zh: '⚡ 計程車前往；招牌布丁；360° 俯瞰洞爺湖', en: '⚡ Take taxi; buy signature pudding; 360° lake panorama' }, maps: 'https://maps.google.com/?q=サイロ展望台+洞爺湖', coord: [42.6017, 140.8017], warn: false },
      { time: '15:13', place: { zh: '洞爺湖畔散步', en: 'Lake Toya Lakeside Stroll' }, duration: '60min', note: { zh: '湖畔自由散策；眺望中島；靜謐時光', en: 'Free lakeside stroll; view Nakanoshima island; peaceful downtime' }, maps: 'https://maps.google.com/?q=Lake+Toya', coord: [42.5951, 140.8027], warn: false },
      { time: '16:13', place: { zh: '湖景飯店 洞爺乃之風（溫泉 + 晚餐）', en: 'Lake View Toya Nonokaze (Onsen + Dinner)' }, duration: '60min', note: { zh: '露天溫泉；自助晚餐含住宿；20:45 湖上煙火', en: 'Outdoor rotenburo; buffet dinner included; 20:45 lake fireworks' }, maps: null, warn: false },
    ],
  ...
  // Day 8
  {
    ...
    items: [
      ...
      { time: '10:12', place: { zh: 'JR 洞爺站 出發 → 登別', en: 'JR Toya Station to Noboribetsu' }, duration: '30min', note: { zh: '計程車至洞爺站 ~5 分；JR 約 20 分', en: 'Taxi to Toya Station ~5 min; JR ~20 min to Noboribetsu' }, maps: 'https://maps.google.com/?q=Toya+Station', coord: [42.6278, 140.8437], warn: false },
      { time: '11:33', place: { zh: '登別站（行李寄置物柜）', en: 'Noboribetsu Station (Station Lockers)' }, duration: '15min', note: { zh: '置物柜 300–400円；巴士至溫泉街 ~10 分', en: 'Lockers 300-400 yen; bus to onsen town ~10 min' }, maps: 'https://maps.google.com/?q=Noboribetsu+Station', coord: [42.4027, 141.1004], warn: false },
      ...
      { time: '16:16', place: { zh: '登別站 → 取行李 → 返洞爺', en: 'Noboribetsu Station — Collect Luggage — Back to Toya' }, duration: '30min', note: { zh: '取出置物柜行李；JR 返回洞爺', en: 'Collect stored luggage; JR back to Toya' }, maps: 'https://maps.google.com/?q=Noboribetsu+Station', coord: [42.4027, 141.1004], warn: false },
      { time: '17:37', place: { zh: 'JR 洞爺站 抵達', en: 'Arrive JR Toya Station' }, duration: '15min', note: { zh: '計程車回乃之風 ~5 分 / 1,000円', en: 'Taxi back to Nonokaze ~5 min / 1,000 yen' }, maps: 'https://maps.google.com/?q=Toya+Station', coord: [42.6278, 140.8437], warn: false },
      { time: '18:04', place: { zh: '湖景飯店 洞爺乃之風（溫泉 + 最後晚餐）', en: 'Lake View Toya Nonokaze (Onsen + Final Dinner)' }, duration: '60min', note: { zh: '溫泉降載；晚餐含住宿；20:45 最後一場煙火', en: 'Onsen recovery; buffet dinner included; 20:45 final fireworks' }, maps: null, warn: false },
    ],
  ...
  // Day 9
  {
    ...
    items: [
      { time: '07:00', place: { zh: '🍳 乃之風自助餐（最後早餐）', en: '🍳 Nonokaze Buffet (Final Breakfast)' }, duration: '150min', note: { zh: '從容早餐；退房前最後泡湯', en: 'Leisurely final breakfast; last onsen soak before check-out' }, maps: null, warn: false },
      { time: '09:42', place: { zh: 'JR 洞爺站 出發 → 新千歲機場', en: 'JR Toya Station to New Chitose Airport' }, duration: '30min', note: { zh: '計程車至洞爺站 ~1,500円；JR 北斗 + 南千歲轉快速機場線；合計 ~4,000–5,000円', en: 'Taxi to Toya ~1,500 yen; JR Hokuto + Airport Rapid at Minami-Chitose; total approx 4,000-5,000 yen' }, maps: 'https://maps.google.com/?q=Toya+Station', coord: [42.6278, 140.8437], warn: true },
      { time: '11:47', place: { zh: '新千歲機場（領行李 + 掛行李報到）', en: 'New Chitose Airport (Yamato Pickup + Check-in Bags)' }, duration: '30min', note: { zh: '⚡ 憑 5/18 宅急便單據領大件行李；先至國際線掛行李（解除負重）', en: '⚡ Use 5/18 Yamato receipt to collect bags; check in at international terminal first' }, maps: 'https://maps.google.com/?q=New+Chitose+Airport', coord: [42.7751, 141.6924], warn: true },
      { time: '12:32', place: { zh: '🍜【午餐】一幻拉麵 新千歲機場店', en: '🍜 Lunch: Ichigen Ramen at New Chitose Airport' }, duration: '60min', note: { zh: '機場最值得吃的一碗；えびそば 1,200円；國內線 3F', en: "Airport's best bowl; shrimp miso ramen 1,200 yen; Domestic Terminal 3F" }, maps: 'https://maps.google.com/?q=一幻+新千歲空港', coord: [42.7751, 141.6924], warn: false },
