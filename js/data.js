...
const DAYS = [
  ...
  // Day 9
  {
    ...
    items: [
      ...
      { time: '11:06', place: { zh: '⚡ 新千歲機場 抵達→黑貓取行李→國際線報到', en: '⚡ New Chitose Airport — Yamato Pickup → International Check-in' }, duration: '60min', note: { zh: '⚡ 直走國際線航廈 到達大廳 2F「システムロゴスカウンター」→ 出示 5/18 粉紅收據領行李 → 同樓層辦 CI131 報到（櫃台同在國際線）', en: '⚡ Head to International Terminal Arrival Lobby 2F "Shizunai Logos Counter" → show 5/18 pink receipt → collect bags → CI131 check-in on same floor' }, maps: 'https://maps.google.com/?q=New+Chitose+Airport', coord: [42.7751, 141.6924], warn: true },
      { time: '12:17', place: { zh: '⚡ 走回國內線 → 自由逛（餐廳 / 名產 / 美食街）', en: '⚡ Walk to Domestic Terminal → Free Explore' }, duration: '108min', note: { zh: '⚡ 國際線↔國內線步行 5–8 分；主要商店都在國內線：3F 美食街（一幻、花畑牧場等）、2F 名產大街；14:00 前須走回國際線辦安檢', en: '⚡ 5-8 min walk between terminals; main shops in Domestic: 3F food court (Ichigen etc.), 2F souvenir street; return to International by 14:00 for security' }, maps: 'https://maps.google.com/?q=New+Chitose+Airport', coord: [42.7751, 141.6924], warn: true },
      { time: '14:05', place: { zh: '⚡ 回國際線 → 最終採買 → 安全檢查 + 出境', en: '⚡ Return to International Terminal → Final Shopping → Security + Immigration' }, duration: '60min', note: { zh: '⚡ 安檢出境後國際線免稅區仍有限定品可掃：Calbee 薯條三兄弟、ROYCE 生巧（買保冷袋）、KINOTOYA 起司塔；過關後就無法再回國內線', en: '⚡ Post-security duty-free: Jaga Pokkuru, ROYCE nama choco (add cold pack), KINOTOYA tart; cannot return to domestic terminal after clearing immigration' }, maps: null, warn: true },
    ...
    tips: [
      ...
      { title: { zh: '領取大件行李（關鍵步驟）', en: 'Yamato Pickup (Critical)' }, body: { zh: '11:06 抵達後直走「國際線航廈」到達大廳 2F，找「システムロゴスカウンター（Shizunai Logos）」窗口，出示 5/18 在ヤマト札幌駅前營業所拿到的粉紅色伝票控え取件。行李領到後直接在同層辦理 CI131 報到，不需要跑國內線。', en: 'After arriving 11:06, walk to International Terminal Arrival Lobby 2F and find "Shizunai Logos Counter". Show the pink receipt from the Yamato Sapporo Station drop-off on 5/18 to collect bags. CI131 check-in is on the same floor — no need to visit the domestic terminal.' } },
      { title: { zh: '機場購物動線', en: 'Airport Shopping Flow' }, body: { zh: '主要購物區在「國內線」，12:17 辦好登機手續後立刻走過去（5–8 分）。記得 14:00 前走回國際線安檢，過關後只能在國際線免稅區掃薯條三兄弟、ROYCE 生巧等限定品。', en: 'Main shops are in the Domestic Terminal — head over right after check-in (5-8 min walk). Return to International by 14:00 for security. Post-immigration duty-free still has Jaga Pokkuru, ROYCE and other exclusives.' } },
    ],
  },
];
