...
const DAYS = [
  ...
  },
  {
    ...
    items: [
      ...
      { time: '13:30', place: { zh: '🍛【午餐】GARAKU 湯咖哩', en: '🍛 Lunch: GARAKU Soup Curry' }, duration: '60min', note: { zh: '札幌神級名店；海老ベース湯咖哩 1,500–2,200円；辣度 0–40 可選', en: 'Sapporo legend; shrimp broth soup curry ¥1,500–2,200; spice level 0–40' }, maps: 'https://maps.google.com/?q=GARAKU+札幌', coord: [43.0604, 141.3555], img: 'images/itinerary/garaku.jpg', warn: false },
  ...
  },
  {
    ...
    items: [
      ...
      { time: '15:30', place: { zh: '☕ 幸運小丑漢堡 碼頭末廣店（下午茶）', en: '☕ Lucky Pierrot Suehiro Branch (Afternoon Snack)' }, duration: '30min', note: { zh: '分食一份炸雞漢堡；函館限定品牌；中華雞腿堡 580円', en: 'Share one Chinese Chicken Burger; Hakodate-only chain; ¥580' }, maps: 'https://maps.google.com/?q=Lucky+Pierrot+Hakodate+Suehiro', coord: [41.7758, 140.7218], img: 'images/itinerary/lucky-pierrot.jpg', warn: false },
      { time: '17:30', place: { zh: '⭐ 函館山觀景台（百萬夜景）', en: '⭐ Mt. Hakodate Observatory (Million Dollar Night View)' }, duration: '90min', note: { zh: '⚡ 出發前查官網風力（15m/s 停駛）；纜車來回 1,500円；山頂比市區冷 5–8°C', en: '⚡ Check wind speed before going (stops at 15m/s); ¥1,500 RT; top is 5–8°C colder' }, maps: 'https://maps.google.com/?q=函館山ロープウェイ', coord: [41.7611, 140.7028], img: 'images/itinerary/hakodate-mt.jpg', warn: true },
